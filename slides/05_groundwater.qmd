...
.row
  ...
  .container width:{60%}
    ...
    .container width:{100%} borderwidth:{1px} background:{yellow} padding:{2px}
...
.row
  ...
  .container width:{60%}
    ...
    .align{center}
      .container alignment:{center} borderwidth:{1px} background:{yellow} padding:{5px}
...
.align{center}
  .html
    <iframe width="400" height="600" src="https://www.youtube.com/embed/FparakKnNZU" height:{100%} width:{20%} a title="Groundwater flow geology lab 💧 There IS water underground!  #geology #hydrology #groundwater" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
.align{center}
  .html
    <iframe width="672" height="378" src="https://www.youtube.com/embed/Tjg0VgBhmgk?si=CyUgW3MrT-xvZcrf&amp;start=7" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
.row
  ...
  .container width:{45%}
    !(100%)[Potentiometric Map Steps](image/franklin_fig_3-18.png "Steps in constructing a potentiometric surface map")
...
.row
  ...
  .container width:{50%}
    !(100%)[Equipotential Example](image/franklin_fig_3-18.png "Equipotential lines and flow arrows on a potentiometric map")
...
.row
  ...
  .container width:{55%}
    !(100%)[Memphis Potentiometric Surface](image/franklin_fig_3-19.png "Potentiometric surface of the Memphis aquifer, showing cones of depression")
...
.row
  ...
  .container width:{45%}
    !(100%)[Hydrograph Example](image/franklin_fig_3-20.png "Long-term water-level hydrograph of Memphis aquifer well")
...
.row
  ...
  .container width:{45%}
    !(100%)[Cross Section](image/franklin_fig_3-21.png "Hydrogeologic cross section with equipotential lines and flow refraction")
