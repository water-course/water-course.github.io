...
.row gap:{1cm}
  ...
  .container width:{50%}
    !(100%)[Aquifer type transition](image/franklin_fig_4-1.png "Aquifers can transition from confined to unconfined")
...
.fullspan
  .center
    .html
      <div class="iframely-embed"><div class="iframely-responsive" style="padding-bottom: 50%; padding-top: 120px;"><a href="https://www.usgs.gov/mission-areas/water-resources/science/principal-aquifers-united-states" data-iframely-url="//iframely.net/PENPjeK2?theme=light"></a></div></div><script async src="//iframely.net/embed.js"></script>

#
.fullspan
  !(100%)[Principal aquifers](image/internet_US_aquifers.png "Principal aquifers in the United States")

#
.fullspan

  .center
    !(80%)[Principal aquifers](image/internet_GA_groundwater.png)

.row gap:{1cm}
  .center
    .container width:{100%} alignment:{center}
        [Groundwater in Australia](https://www.ga.gov.au/scientific-topics/water/groundwater/groundwater-in-australia)

#
!(50%)[Principal aquifers](image/internet_parlimant_GW.jpg "Principal aquifers in the United States")
...
.fullspan
  .align{center}
    !(50%)[Basin and Range aquifers](image/basinandrange.gif "Basin-fill aquifers in Basin and Range Province")
...
.row gap:{1cm}
  .container width:{50%}
    !(100%)[Sandstone Aquifers](image/usgs_sandstone_aquifers.gif "Principal sandstone aquifers in the United States")
...
.row gap:{1cm}
  .container width:{50%}
    !(100%)[Carbonate-Rock Aquifers](image/usgs_carbonate_rocks.gif "Principal carbonate-rock aquifers in the United States")
