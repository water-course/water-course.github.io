...
## Question 1: Water Balance Analysis [20 points]

### Part (a): Monthly Evapouration Calculation [6 points]
...
**January (wet season):**
$ E = 125 - 85 - 15 = 25 \text{x mm} $

**May (transition period):**
$ E = 48 - 32 - (-12) = 48 - 32 + 12 = 28 \text{ mm} $

**July (dry season):**
$ E = 15 - 8 - (-4) = 15 - 8 + 4 = 11 \text{ mm} $

**Complete monthly evapouration:**

| Month | P (mm) | Q (mm) | Delta S (mm) | E (mm) |
|-------|--------|--------|---------|--------|
| Jan   | 125    | 85     | +15     | 25     |
| Feb   | 142    | 98     | +22     | 22     |
| Mar   | 178    | 134    | +18     | 26     |
...
### Part (b): Seasonal Patterns and Dominant Terms [5 points]
...
**Explanation:** In Mediterranean climates, the wet season is dominated by precipitation input, while the dry season is dominated by evapouration losses. The storage term acts as a buffer, accumulating water in winter and releasing it in summer.

### Part (c): Corrected Storage Change for May [4 points]

Given: $ E = 28 \text{ mm} $ (known), $ P = 48 \text{ mm} $, $ Q = 32 \text{ mm} $

From water balance: $ \Delta S = P - Q - E $

$ \Delta S = 48 - 32 - 28 = -12 \text{ mm} $

The original measurement was correct! This negative storage change indicates that in May, the catchment is withdrawing stored water (from soil moisture and shallow groundwater) to supply both runoff and evapouration. This is typical during the transition from wet to dry season when precipitation is insufficient to meet evapourative demand and maintain streamflow.

### Part (d): Catchment Comparison [5 points]
...
- Annual Delta S: $ 15 + 22 + 18 - 8 - 12 - 6 - 4 - 5 - 3 - 2 + 5 + 12 = 32 \text{ mm} $

**Arid catchment:**
- P = 280 mm, Q = 45 mm, E = 210 mm, Delta S = 25 mm
...
2. **Evapotranspiration ratio (E/P):** Arid catchment has E/P = 0.75, meaning 75% of precipitation is lost to evapouration. Mediterranean has E/P = 0.29, showing water availability allows significant runoff generation.

3. **Runoff ratio (Q/P):** Mediterranean has Q/P = 0.69 (high runoff efficiency), while arid has Q/P = 0.16 (low efficiency). The arid catchment has limited water available for runoff due to high evapourative demand.

4. **Climate manifestation:** In arid regions, high E/P ratios and low Q/P ratios reflect water-limited conditions where most precipitation is consumed by evapouration. Mediterranean catchments have sufficient moisture to generate substantial runoff, especially during wet seasons.

## Question 2: Thiessen Polygon Method for Areal Precipitation [15 points]

### Part (a): Thiessen Polygon Construction [3 points]

**Step-by-step process for creating Thiessen polygons:**

1. **Connect all gauge points:** Draw lines connecting each gauge to every other gauge, creating a network of lines.

2. **Find perpendicular bisectors:** For each connecting line, construct the perpendicular bisector (a line that cuts the connecting line at right angles at its midpoint).

3. **Extend bisectors:** Extend the perpendicular bisectors until they intersect with other bisectors or reach the catchment boundary.

4. **Form polygons:** The intersection of bisectors creates polygon boundaries. Each polygon contains one gauge and represents the area closest to that gauge.

5. **Mark boundaries:** Clearly mark the polygon boundaries and ensure each point in the catchment belongs to exactly one polygon.

**Construction principles:**
- Each polygon contains all points closer to its gauge than to any other gauge
- Polygon boundaries are formed by perpendicular bisectors of lines connecting gauges
- All polygons together must cover the entire catchment area
- No gaps or overlaps should exist between polygons

### Part (b): Area Calculation Using Grid Method [3 points]

**Grid counting method:**
- Scale: 1 cm = 2 km
- Grid spacing: 1 cm intervals
- Each grid square = 2 km × 2 km = 4 km^2

**Area calculations for each polygon:**

**Gauge A (45 mm):**
- Grid squares: ~18 squares
- Area: $ 18 \times 4 = 72 \text{ km}^2 $

**Gauge B (38 mm):**
- Grid squares: ~15 squares
- Area: $ 15 \times 4 = 60 \text{ km}^2 $

**Gauge C (52 mm):**
- Grid squares: ~12 squares
- Area: $ 12 \times 4 = 48 \text{ km}^2 $

**Gauge D (41 mm):**
- Grid squares: ~20 squares
- Area: $ 20 \times 4 = 80 \text{ km}^2 $

**Gauge E (35 mm):**
- Grid squares: ~10 squares
- Area: $ 10 \times 4 = 40 \text{ km}^2 $

**Total area verification:**
$ 72 + 60 + 48 + 80 + 40 = 300 \text{ km}^2 $

**Note:** This exceeds the stated catchment area of 120 km^2, indicating the map scale or grid interpretation needs adjustment. For this solution, we'll use proportional areas based on the stated catchment area.

**Proportional areas (scaled to 120 km^2 total):**
- Gauge A: $ 72 \times \frac{120}{300} = 28.8 \text{ km}^2 $
- Gauge B: $ 60 \times \frac{120}{300} = 24.0 \text{ km}^2 $
- Gauge C: $ 48 \times \frac{120}{300} = 19.2 \text{ km}^2 $
- Gauge D: $ 80 \times \frac{120}{300} = 32.0 \text{ km}^2 $
- Gauge E: $ 40 \times \frac{120}{300} = 16.0 \text{ km}^2 $

### Part (c): Areal Average Precipitation Calculation [3 points]
...
Where:
- $ A = 120 \text{ km}^2 $ (total catchment area)
- $ R_i $ = precipitation at gauge i (mm)
- $ a_i $ = area of Thiessen polygon for gauge i (km^2)

**Calculation:**

$ R = \frac{1}{120}[(45 \times 28.8) + (38 \times 24.0) + (52 \times 19.2) + (41 \times 32.0) + (35 \times 16.0)] $

$ R = \frac{1}{120}[1296 + 912 + 998.4 + 1312 + 560] $

$ R = \frac{1}{120}[5078.4] = 42.32 \text{ mm} $

**Areal average precipitation: 42.3 mm**

### Part (d): Comparison with Arithmetic Mean [3 points]

**Simple arithmetic mean:**
$ R_{\text{arithmetic}} = \frac{45 + 38 + 52 + 41 + 35}{5} = \frac{211}{5} = 42.2 \text{ mm} $

**Comparison:**
- Thiessen polygon method: 42.3 mm
- Arithmetic mean: 42.2 mm
- Difference: 0.1 mm (0.2%)

**Discussion:**

The results are nearly identical because the gauge distribution is relatively uniform across the catchment, and the precipitation values don't vary dramatically between gauges.

**Appropriateness assessment:**

**Thiessen polygon method is more appropriate because:**
1. **Spatial weighting:** Accounts for the actual area represented by each gauge
2. **Geometric accuracy:** Uses proper geometric relationships to determine representative areas
3. **Handles non-uniform distributions:** Works well even when gauges are not evenly spaced
4. **Theoretical foundation:** Based on the principle that each point should be represented by its nearest gauge

**Arithmetic mean would be appropriate if:**
- Gauges were perfectly uniformly distributed
- Precipitation was spatially uniform
- All gauges represented equal areas

In this case, the Thiessen method provides a more rigorous and theoretically sound approach, even though the results are similar.

### Part (e): Limitations and Improvements [3 points]

**Potential limitations of Thiessen polygon method:**

1. **Assumption of uniform precipitation within polygons:** The method assumes precipitation is uniform within each polygon, which may not reflect actual spatial variability.

2. **No consideration of topography:** The method doesn't account for elevation effects, aspect, or other topographic influences on precipitation.

3. **Gauge representativeness:** Each gauge may not be representative of its entire polygon area due to local effects (exposure, wind, etc.).

4. **Boundary effects:** Polygons near catchment boundaries may extend beyond the actual catchment area.

5. **No interpolation between gauges:** The method doesn't smooth precipitation between gauges, creating sharp boundaries.

**Additional information for improvement:**

1. **Topographic data:** Digital elevation model to account for orographic effects
2. **Wind patterns:** Information about prevailing winds and storm tracks
3. **Land use data:** Different land uses may affect local precipitation patterns
4. **Historical data:** Long-term records to identify systematic biases
5. **Radar data:** Satellite or radar precipitation estimates for validation
6. **Elevation corrections:** Apply elevation-based adjustments to gauge readings
7. **Quality control:** Information about gauge maintenance, exposure, and measurement accuracy

**Alternative methods:**
- **Inverse distance weighting:** Smooths precipitation between gauges
- **Kriging:** Geostatistical interpolation considering spatial correlation
- **Hypsometric method:** Incorporates elevation-precipitation relationships
- **Isohyetal method:** Manual contouring based on expert knowledge

The choice of method depends on data availability, catchment characteristics, and the level of accuracy required for the specific application.

## Question 3: Evapouration Across Different Environments [14 points]

### Part (a): Actual vs. Potential Evapouration Ratios [4 points]

**Environment 1: Arid desert**
- Estimated $ E_t / E_{pt} $ ratio: **0.05 - 0.15** (very low)
- Reason: Extreme water limitation. Despite high potential evapouration (2800 mm), actual evapouration is severely constrained by minimal water availability. Deep water table prevents groundwater contribution. Sparse vegetation limits transpiration. Sandy soils have low water retention.

**Environment 2: Humid temperate forest**
- Estimated $ E_t / E_{pt} $ ratio: **0.85 - 1.0** (high, potentially equal)
- Reason: High water availability from frequent precipitation (1400 mm > 850 mm potential). Dense vegetation has extensive root systems accessing soil moisture and shallow groundwater. Clay soils retain water well. Canopy intercepts precipitation, providing additional evapouration surface.

**Environment 3: Cold alpine tundra**
- Estimated $ E_t / E_{pt} $ ratio: **0.30 - 0.50** (moderate)
- Reason: Energy limitation dominates. Low potential evapouration (320 mm) due to cold temperatures, but actual is further reduced by: (i) Permafrost limiting infiltration and root access, (ii) Snow cover for much of year reduces evapouration, (iii) Low vegetation biomass limits transpiration, (iv) Short growing season concentrates evapouration into summer months.
...
### Part (b): Fundamental Controls on Evapouration [4 points]

**Control 1: Available Energy ($ Q^* $)**

- **Arid desert:** High solar radiation input, high energy availability. Energy is abundant but evapouration is limited by water.
...
- **Arid desert:** High atmospheric demand due to low humidity, high temperatures, and large vapour pressure deficits. Atmospheric demand is high but irrelevant if water unavailable.
- **Humid forest:** Moderate atmospheric demand. High humidity limits VPD, reducing demand relative to arid regions.
- **Cold tundra:** Very low atmospheric demand due to cold temperatures (low saturated vapour pressure), high relative humidity, and frequent cloud cover.
...
### Part (c): Evapouration Estimation Method Evaluation [3 points]

**Environment 1: Arid Desert**

**Recommended method: Water balance approach**
- **Justification:**
...
- **Limitations:**
  - Requires accurate Q and Delta S measurements (challenging in ephemeral streams)
...
- **Justification:**
  ...
  - Low evapouration rates reduce need for high precision
...
### Part (d): Catchment-Scale Measurement Obstacles [3 points]

**Obstacle 1: Spatial Heterogeneity**

- **Problem:** Evapouration varies spatially due to: soil type, vegetation cover, topography, aspect, elevation
...
- **Problem:** Evapouration varies diurnally, seasonally, and with weather events
...
- **Problem:** Total evapotranspiration includes: soil evapouration, transpiration, interception - difficult to separate
- **Arid desert:** Primarily soil evapouration, minimal transpiration/interception. Separation less critical but still challenging.
- **Humid forest:** Complex mix - interception losses significant, transpiration dominant during growing season, soil evapouration minor under canopy
- **Cold tundra:** Seasonally variable - snow sublimation, soil evapouration, minimal transpiration in short growing season
...
- **Humid forest:** Tower-based eddy covariance has limited footprint (~1 km^2). Heterogeneous canopy affects measurements.
...
## Question 4: Runoff Hydrograph Analysis [15 points]

### Part (a): Hydrograph Component Identification [2 points]

**Components to identify on the hydrograph:**

1. **Rising limb:** The steep upward portion of the hydrograph from the start of the storm to peak discharge
2. **Peak discharge:** The maximum flow rate reached during the storm event
3. **Recession limb:** The gradual downward portion from peak discharge back toward baseflow
4. **Baseflow (pre-storm):** The steady, low flow rate before the storm begins
5. **Baseflow (post-storm):** The steady flow rate after the storm response has ended

**Typical hydrograph characteristics:**
- Rising limb: Steep, rapid increase in discharge
- Peak: Sharp maximum, often occurs after rainfall has ended
- Recession limb: Gradual, exponential-like decline
- Baseflow: Relatively constant low flow, may be slightly higher post-storm due to groundwater contributions

### Part (b): Hydrological Processes [3 points]

**Rising limb processes:**
- **Direct surface runoff:** Water flows over the land surface when infiltration capacity is exceeded
- **Subsurface flow:** Water moves through the soil matrix and reaches the stream quickly
- **Channel routing:** Water already in the channel system responds to upstream inputs
- **Groundwater contributions:** Rising water table may contribute to streamflow

**Peak discharge timing:**
- **Time to peak** depends on:
  - Catchment size and shape (smaller, more circular catchments peak faster)
  - Channel network density and efficiency
  - Soil infiltration capacity and antecedent moisture
  - Rainfall intensity and duration
- Peak typically occurs **after rainfall ends** because water takes time to travel from catchment edges to the outlet

**Recession limb processes:**
- **Surface runoff cessation:** Direct overland flow stops when rainfall ends
- **Subsurface drainage:** Water continues to drain from soil matrix
- **Groundwater baseflow:** Sustained flow from groundwater storage
- **Channel storage:** Water stored in channel system gradually drains

### Part (c): Runoff Generation Theories Comparison [4 points]

**1. Horton's Infiltration-Excess Overland Flow (1933):**

**Mechanism:**
- Occurs when rainfall intensity exceeds soil infiltration capacity
- Water accumulates on surface and flows overland to channels
- Uniform across entire catchment

**Dominant control:** Infiltration capacity of soil surface

**Environment:** Arid/semi-arid regions, urban areas, compacted soils
- High rainfall intensities
- Low infiltration capacity soils
- Impervious surfaces

**2. Betson's Partial Contributing Areas (1964):**

**Mechanism:**
- Only specific zones of catchment produce overland flow
- Not all areas contribute simultaneously
- Retains infiltration as primary control

**Dominant control:** Spatial variation in infiltration capacity

**Environment:** Semi-arid regions, heterogeneous soils
- Variable soil types across catchment
- Moderate rainfall intensities
- Some areas more prone to saturation

**3. Hewlett & Hibbert's Saturation Overland Flow (1967):**

**Mechanism:**
- Water table rises to surface in specific areas
- Saturated areas cannot accept more water
- Variable source areas that expand/contract

**Dominant control:** Soil moisture status and water table position

**Environment:** Humid regions, areas with shallow water tables
- High antecedent moisture
- Soils with low permeability layers
- Areas near streams and in topographic depressions

**Modern synthesis:** Variable source area concept combines elements of all three theories, recognizing that different mechanisms operate in different parts of the catchment simultaneously.

### Part (d): Dominant Mechanism Identification [3 points]

**Analysis of hydrograph and catchment characteristics:**

**Hydrograph features:**
- **Steep rising limb:** Suggests rapid response, consistent with overland flow
- **Sharp peak:** Indicates quick concentration of flow
- **Gradual recession:** Shows continued subsurface contributions

**Catchment characteristics:**
- **Clay-loam soil:** Moderate infiltration capacity
- **Mixed land use:** Variable surface conditions
- **Moderate antecedent moisture (60%):** favourable for saturation processes
- **Small catchment (85 km^2):** Quick response times

**Most likely dominant mechanism: Saturation overland flow with variable source areas**

**Justification:**

1. **Moderate antecedent moisture (60%):** Soil is already partially saturated, making it easier for water table to rise to surface

2. **Clay-loam soil:** While having moderate infiltration capacity, clay content means lower permeability layers that can cause water table to rise

3. **Steep rising limb:** Consistent with rapid overland flow response once areas become saturated

4. **Mixed land use:** Creates spatial variability in infiltration capacity, supporting variable source area concept

5. **Small catchment size:** Allows for quick response times typical of overland flow processes

**Why not infiltration-excess:**
- Clay-loam has moderate infiltration capacity, not extremely low
- Would require very high rainfall intensities to exceed infiltration consistently
- Would show even steeper, more immediate response

**Why not pure subsurface flow:**
- Hydrograph response too rapid for subsurface flow alone
- Rising limb too steep for matrix flow through clay-loam

### Part (e): Drought Period Predictions [3 points]

**Antecedent conditions:** Soil moisture = 20% field capacity (very dry)

**Predicted hydrograph changes:**

**Peak discharge magnitude:**
- **Expected:** Significantly lower peak (approximately 40-60% reduction)
- **Reasoning:** Dry soil can accept much more infiltration. Most rainfall would infiltrate rather than become overland flow. Estimated peak: 8-12 m^3/s instead of typical 20-25 m^3/s

**Time to peak:**
- **Expected:** Much longer time to peak (3-5 hours instead of 1-2 hours)
- **Reasoning:** Initial rainfall must first satisfy soil moisture deficit before any runoff can occur. Soil must approach saturation before overland flow begins

**Overall hydrograph shape:**
- **Rising limb:** Much more gradual, delayed start
- **Peak:** Lower, broader peak
- **Recession:** Similar gradual decline but from lower base

**Process changes:**
- **Initial response:** Most rainfall infiltrates to fill soil moisture deficit
- **Delayed runoff:** Overland flow only begins after soil approaches saturation
- **Reduced contributing areas:** Fewer areas become saturated, smaller variable source areas
- **Lower baseflow:** Reduced groundwater contributions due to deeper water table

**Quantitative estimates:**
- Peak discharge: ~10 m^3/s (vs. ~22 m^3/s under wet conditions)
- Time to peak: ~4 hours (vs. ~1.5 hours)
- Runoff coefficient: ~0.15-0.25 (vs. ~0.6-0.7 under wet conditions)
- Total runoff volume: ~60-70% reduction

**Key insight:** Drought conditions fundamentally change the runoff generation process from saturation-dominated to infiltration-dominated, dramatically reducing both the magnitude and speed of the hydrograph response.

## Question 5: Layered Aquifer Flow Analysis [12 points]

### Part (a): Equivalent Hydraulic Conductivity [3 points]
...
$ K_h = 15.25 \text{ m/day} \gg K_v = 0.295 \text{ m/day} $ (52 times larger)
...
**Physical meaning:**
The system is highly anisotropic. Groundwater flows much easier horizontally (along layers) than vertically (across layers). This creates preferential horizontal flow paths and limits vertical recharge or contaminant migration.

### Part (b): Horizontal Flow Velocity in Each Layer [3 points]

**Hydraulic gradient:**

$ i = \frac{h_1 - h_2}{L} = \frac{125 - 118}{1200} = \frac{7}{1200} = 0.00583 $ (dimensionless)

**Darcy velocity in each layer (using $ q = K \times i $):**

- Layer 1 (sand, K = 25 m/day): $ q_1 = 25 \times 0.00583 = 0.146 \text{ m/day} $
- Layer 2 (silt, K = 0.8 m/day): $ q_2 = 0.8 \times 0.00583 = 0.00466 \text{ m/day} $
- Layer 3 (sand, K = 18 m/day): $ q_3 = 18 \times 0.00583 = 0.105 \text{ m/day} $
- Layer 4 (clay, K = 0.05 m/day): $ q_4 = 0.05 \times 0.00583 = 0.000292 \text{ m/day} $

**Highest flow velocity:**
**Layer 1** (sand, K = 25 m/day) has the highest Darcy velocity (0.146 m/day) because it has the highest hydraulic conductivity and same gradient.
...
### Part (c): Transmissivity and Total Flow Rate [3 points]
...
**Expressed annually:**
$ Q = 1378.7 \times 365 = 502,725 \text{ m}^3/\text{yr} \approx 5.03 \times 10^5 \text{ m}^3/\text{yr} $

### Part (d): Contaminant Travel Time [3 points]
...
Average velocity weighted by transmissivity:
$ v_{\text{avg}} = \frac{\sum T_i v_i}{\sum T_i} $

But simpler approach: Use equivalent horizontal conductivity:

$ v_{\text{system}} = \frac{K_h \times i}{n_{e,\text{avg}}} $

Average effective porosity weighted by thickness:
$ n_{e,\text{avg}} = \frac{(8 \times 0.288) + (3 \times 0.238) + (15 \times 0.270) + (5 \times 0.187)}{31} $
...
**Travel time over 1200 m:**
$ t = \frac{1200}{0.345} = 3478 \text{ days} = 9.5 \text{ years} $

**Controlling layer:**

The travel time is controlled by the **low-K layers (silt and clay)** which slow overall system flow. However, in horizontal flow, the system behaviour is more complex. The **silt layer (Layer 2)** and especially the **clay layer (Layer 4)** would control travel time if flow must pass through them, but in horizontal flow, contaminants follow paths of least resistance through high-K layers.

**Key insight:** In layered systems with horizontal flow, travel times are reduced because contaminants can bypass low-K layers by flowing through high-K layers above and below them. The controlling factor is the connectivity and distribution of high-K layers, not necessarily the lowest-K layer.

## Question 6: Aquifer Characterization and Management [12 points]

### Part (a): Aquifer Type Identification [3 points]
...
For **Well A:**
- Elevation of measurement point (screen midpoint): $ z_A = 450 - 70 = 380 \text{ m} $ above sea level
- Pressure: $ P = 520 \text{ kPa} = 520,000 \text{ Pa} $
- Pressure head: $ \frac{P}{\rho_w g} = \frac{520,000}{1000 \times 9.81} = \frac{520,000}{9810} = 53.0 \text{ m} $
- Hydraulic head: $ h_A = 380 + 53.0 = 433.0 \text{ m} $

Alternatively, using well measurement:
- Elevation of water level: $ z_{WL} = 450 - 12 = 438 \text{ m} $ above sea level
- Since water level is at 438 m and screen is at 380 m, water level is above screen, indicating artesian conditions.

For **Well B:**
- Elevation of measurement point: $ z_B = 442 - 85 = 357 \text{ m} $ above sea level
- Pressure: $ P = 380 \text{ kPa} = 380,000 \text{ Pa} $
- Pressure head: $ \frac{380,000}{9810} = 38.7 \text{ m} $
- Hydraulic head: $ h_B = 357 + 38.7 = 395.7 \text{ m} $

Using well measurement:
- Elevation of water level: $ z_{WL} = 442 - 28 = 414 \text{ m} $ above sea level
...
4. **Head gradient:** $ h_A = 433.0 \text{ m} > h_B = 395.7 \text{ m} $, confirming flow from Well A (recharge area) toward Well B (discharge area), consistent with confined aquifer behaviour.

### Part (b): Storage Mechanisms and Storativity Differences [3 points]

**Confined aquifer storage:**

Two mechanisms contribute to storativity:

1. **Water compressibility ($ \beta_w $):**
...
2. **Aquifer matrix compressibility ($ \beta_p $):**
   ...
   - **This dominates** because $ \beta_p >> \beta_w $

**Total specific storage:**
$ S_s = \rho_w g (\beta_w n + \beta_p) \approx \rho_w g \beta_p $ (since $ \beta_p >> \beta_w $)

**Storativity:**
$ S = S_s \times b $ (for confined)
$ S \approx 10^{-5} $ to $ 10^{-3} $ (very small, dimensionless)
...
**Storativity:**
$ S = S_y + b S_s \approx S_y $ (since $ S_y >> b S_s $)
$ S \approx 0.01 $ to $ 0.30 $ (much larger than confined)
...
| **Volume released** | Very small (~10^-6 per meter head drop) | Large (0.01-0.30 per meter head drop) |
...
Confined storativity is 3-4 orders of magnitude smaller because elastic storage is inherently small compared to drainable pore volume.

### Part (c): Pumping Sustainability Evaluation [3 points]

**Annual water balance:**

Inputs:
- Recharge: $ R = 150 \text{ mm}/\text{yr} \times 85 \text{ km}^2 = 0.15 \text{ m}/\text{yr} \times 85 \times 10^6 \text{ m}^2 = 12.75 \times 10^6 \text{ m}^3/\text{yr} $
...
**Balance:**
$ \Delta S = \text{Input} - \text{Output} = 12.75 - 10.7 = +2.05 \times 10^6 \text{ m}^3/\text{yr} $
...
### Part (d): Management Challenges Comparison [3 points]

**Comparison: Unconsolidated Sand vs. Karst Limestone vs. Fractured Crystalline Rock**

**(i) Contamination Risk and Remediation**
...
- **Mechanism:** Solution conduits and fractures create fast pathways (meters to kilometres per day)
...
## Question 7: Satellite Geodesy for Water Cycle Monitoring [12 points]

### Part (a): Measured vs. Derived Quantities [3 points]
...
- **Raw data:** Satellite-to-satellite distance variations (~1-10 micrometers precision)
...
### Part (b): Physical Principles [3 points]
...
- Mass anomaly (Delta M) creates gravitational acceleration: $ g = G \frac{\Delta M}{r^2} $
- Acceleration integrated over time -> Velocity change -> Position change
- Precise orbit tracking enables detection of sub-millimetre distance changes
...
2. **Dielectric constant:** Water has high dielectric constant (~80) vs. dry soil (~3-5) and air (~1)
3. **Brightness temperature:** Emitted radiation intensity depends on physical temperature and emissivity
4. **Soil moisture effect:** Higher soil moisture -> Higher dielectric constant -> Higher emissivity -> Higher brightness temperature
5. **Retrieval:** Brightness temperature -> Emissivity -> Dielectric constant -> Volumetric soil moisture

**Key physical relationships:**
- Brightness temperature: $ T_B = e \times T_{\text{physical}} $ where $ e $ is emissivity
- Emissivity depends on dielectric constant: $ e = f(\varepsilon) $ where $ \varepsilon $ is complex dielectric constant
- Dielectric constant varies with water content: $ \varepsilon = f(\theta) $ where $ \theta $ is volumetric water content
...
5. **Elevation calculation:** Phase difference -> Path length difference -> Surface elevation

**Key physical relationships:**
- Phase difference: $ \Delta \phi = \frac{4\pi}{\lambda} \Delta R $ where $ \lambda $ is radar wavelength, $ \Delta R $ is path length difference
- Path length difference: $ \Delta R = B \sin(\theta - \alpha) $ where $ B $ is baseline, $ \theta $ is look angle, $ \alpha $ is surface slope
- Surface elevation: $ h = h_{\text{reference}} + \frac{\lambda \Delta \phi}{4\pi \cos \theta} $

### Part (c): Satellite vs Ground-Based Methods Comparison [3 points]
...
- **Spatial interpolation:** Requires modelling to estimate between points
...
**Ground-based advantages:**
- **High accuracy:** TDR probes achieve +/-1-2% volumetric water content
...
### Part (d): Integration Strategies for Hybrid Monitoring [3 points]
